...
import "../css/AboutServiceContact2.css";
      ...
      <div className="all_services-1">
        <div className="all-services-2">
          ...
          <div className="tab-content_item">
            ...
            <p>İş elanı yerləşdirmək üçün, sizdən vakant iş yeri haqqında məlumatı  ünvanına Word formatında göndərməyiniz xahiş olunur. Mətnin daha rahat oxunması üçün bizim tərəfdən müəyyən qrammatik düzəlişlər aparıla bilər. </p>
...
export default Service;
      ...
      //     info@jobsearch.az ünvanına Word formatında göndərməyiniz xahiş olunur.
      //     Mətnin daha rahat oxunması üçün bizim tərəfdən müəyyən qrammatik
      //     düzəlişlər aparıla bilər. İşədüzəltmə üzrə beynəlxalq standart və
      //     prinsiplərə cavab verməyən, dəfələrlə bu prinsipləri pozmuş, həmçinin
      //     qeyri-qanuni fəaliyyətlə məşğul olan işəgötürən şirkətlərin
      //     elanlarının saytımızda yerləşdirilməsinə imtina verə bilərik.
      ...
      //     administratoru kimi həmin məlumatlar bizə təqdim olunmalıdır. Bitmə
      //     tarixi qeyd olunmayan iş elanları maksimum tarix olaraq 1 aylıq
      //     götürüləcək. Bu müddət əlavə ödəniş olunmaqla artırıla bilər. İş
      //     elanının yerləşdirilməsi üçün Əlaqə bölməsinə də müraciət edə
      //     bilərsiniz.
      //   </p>
      // </div>
      // <div>
      ...
      //     ölçüsündən və saytda olan yerindən asılıdır. Əlavə məlumat əldə etmək
      //     üçün Əlaqə bölməsindən müraciət edə bilərsiniz.
      //   </p>
      // </div>
      // <div>
      //   <h2>İş elanı Storilərinin yerləşdirilməsi </h2>
      ...
      //     elanın Storisi saytın sol menyusunun bütün bölmələrində əmələ gələcək,
      //     bu sizin auditoriyanızın daha da genişlənməsinə imkan yaradacaq, həm
      //     də şirkəti işaxtaranlar arasında daha da yaxşı tanıdacaq. Storidə
      //     elanın yerləşdirilməsi üçün xidmət haqqı əlavə 5 manat təşkil edir.
      //   </p>
      // </div>
      // <div>
      //   <h2>Xidmətin ödənişi</h2>
